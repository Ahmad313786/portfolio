  ...
  return (
    <div id='home' className='min-h-screen flex items-center justify-center relative' >
      ...
      <div className='text-center px-10 z-10' >
        <h1 className='text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right' >Hi, I am Ahmad Hassan</h1>
        <p className='text-gray-400 text-lg mb-8 max-w-lg mx-auto' >I'm a full stack web developer who enjoys creating clean, responsive, and efficient web applications. I specialize in building seamless user experiences and robust back-end systems.</p>
